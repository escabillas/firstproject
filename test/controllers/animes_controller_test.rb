...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { episode: @anime.episode, season: @anime.season, title: @anime.title } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { episode: @anime.episode, season: @anime.season, title: @anime.title } }
